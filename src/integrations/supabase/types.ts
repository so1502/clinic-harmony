    ...
    Tables: {
      appointments: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "appointments_therapy_type_id_fkey"
      ...
      therapists: {
        ...
        Relationships: [
          ...
          {
            foreignKeyName: "therapists_user_id_profiles_fkey"
            columns: ["user_id"]
            isOneToOne: true
      ...
      therapy_types: {
        ...
        Relationships: [
          {
            foreignKeyName: "therapy_types_clinic_id_fkey"
            columns: ["clinic_id"]
            isOneToOne: false
            referencedRelation: "clinics"
            referencedColumns: ["id"]
